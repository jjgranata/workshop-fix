...
@LargeTest
public class CreateOrUpdateCurrentJobActivityTest {
    @Rule
    public ActivityScenarioRule<CreateOrUpdateCurrentJobActivity> createOrUpdateCurrentJobActivityActivityRule =
            new ActivityScenarioRule<>(CreateOrUpdateCurrentJobActivity.class);
    ...
    public void ShouldConfirmWidgetsAreAlignedCorrectly() {
        ...
        onView(withId(R.id.textViewTeleworkDays)).check(isCompletelyAbove(withId(R.id.button_save)));
        ...
        onView(withId(R.id.editTextTeleworkDays)).check(isCompletelyAbove(withId(R.id.button_save)));

        onView(withId(R.id.button_save)).check(matches(isDisplayed()));
        onView(withId(R.id.button_save)).check(isCompletelyAbove(withId(R.id.button_cancel)));

        onView(withId(R.id.button_cancel)).check(matches(isDisplayed()));
    }

    @Test
    public void ShouldEnterAndSaveJob() {
        ...
        ViewInteraction tv = onView(withId(R.id.textViewCurJobEntered));
